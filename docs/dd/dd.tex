...
\begin{figure}[H]
  	\centering
  	\includegraphics[width=0.75\linewidth]{MVVM-light}
  	\label{fig:test1}
...
Unfortunately, we were not able to make this framework work due to the highly asynchronous nature of our main views, an approach suggested by our Bending Spoons tutor aimed to make the views more responsive.
