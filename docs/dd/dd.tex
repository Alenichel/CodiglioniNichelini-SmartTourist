...
\begin{itemize}
	...
	\item Updating the application's state using pure functions is nice and it has a lot of benefits. Applications have to deal with the external world though (e.g., API call, disk files management, …). For all this kind of operations, Katana provides the concept of \textbf{side effects}. Side effects can be used to interact with other parts of your applications and then dispatch new StateUpdaters to update your state.
...
\section{Tempura}
Quoting from Tempura's \href{https://github.com/BendingSpoons/tempura-swift}{documentation}\footnote{https://github.com/BendingSpoons/tempura-swift}:
